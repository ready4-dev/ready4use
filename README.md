...
<!-- badges: start -->
[![R-CMD-check](https://github.com/ready4-dev/ready4use/workflows/R-CMD-check/badge.svg)](https://github.com/ready4-dev/ready4use/actions)
...
ready4use provides a set of classes and methods for general
data management tasks throughout the ready4 suite of tools for mental
health data synthesis and modelling projects.  This development
version of the ready4use package has been made available as part of
