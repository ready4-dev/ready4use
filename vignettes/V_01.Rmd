...
```{r}
y <- Ready4useDyad(ds_tb = procure(procureSlot(x,"b_Ready4useIngest"), fl_nm_1L_chr = "ymh_clinical_tb"),
                   dictionary_r3 = procure(procureSlot(x,"b_Ready4useIngest"), fl_nm_1L_chr = "ymh_clinical_dict_r3"))
```
