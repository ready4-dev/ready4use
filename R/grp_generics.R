#' Download data
#' @name download_data
#' @description download_data() is a Download Data generic that downloads data files.NA
#' @param x An object
...
#' Get data
#' @name get_data
#' @description get_data() is a Get Data generic that retrieves data from R objects loaded in memory.NA
#' @param x An object
#' @param ... Additional arguments
#' @export 
...
#' Import data
#' @name import_data
#' @description import_data() is an Import Data generic that imports data from saved files and loads them into memory as R objects.NA
#' @param x An object
#' @param ... Additional arguments
#' @export 
...
#' Save raw
#' @name save_raw
#' @description save_raw() is a Save Raw generic that saves the native version of a file format.NA
#' @param x An object
#' @param ... Additional arguments
#' @export 
...
#' @description update_src_loc_to_url() is an Update Source Local to Url generic that updates data from a local file reference to a URLNA
#' @param x An object
...
#' Update this
#' @name update_this
#' @description update_this() is an Update this generic that updates and objectNA
#' @param x An object
#' @param ... Additional arguments
#' @export 
