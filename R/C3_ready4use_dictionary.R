...
#' Make new ready4use dictionary ready4 s3 class defining a data dictionary tibble.
...
#' Make prototype ready4use dictionary ready4 s3 class defining a data dictionary tibble.
...
#' Validate ready4use dictionary ready4 s3 class defining a data dictionary tibble.
...
purrr::map2_chr(make_pt_ready4use_dictionary() %>% 
dplyr::summarise_all(class) %>% 
 tidyr::gather(variable,class) %>% 
dplyr::pull(1),
...
x}
#' Is ready4use dictionary ready4 s3 class defining a data dictionary tibble.
