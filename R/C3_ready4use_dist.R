...
#' @param x A prototype for the ready4 S3 class for list object that summarises the parameters of each distribution, Default: make_pt_ready4use_dist()
...
#' @details ready4 S3 class for list object that summarises the parameters of each distribution
#' @rdname make_new_ready4use_dist
#' @export 

make_new_ready4use_dist <- function(x){ 
stopifnot(is.list(x))
class(x) <- append(c("ready4use_dist",setdiff(make_pt_ready4use_dist() %>% class(),class(x))),
class(x))
x
}
...
#' @details ready4 S3 class for list object that summarises the parameters of each distribution
#' @rdname make_pt_ready4use_dist
#' @export 
#' @importFrom ready4fun update_pt_fn_args_ls
#' @importFrom rlang exec
make_pt_ready4use_dist <- function(distribution_chr = character(0),
...
names(make_pt_ready4use_dist()) %>% stringr::str_c(sep="", collapse = ", ")),
call. = FALSE)
}
...
#' @details ready4 S3 class for list object that summarises the parameters of each distribution
#' @rdname is_ready4use_dist
#' @export 

is_ready4use_dist <- function(x) inherits(validate_ready4use_dist(x), "ready4use_dist")
