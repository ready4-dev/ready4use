...
methods::setMethod("share", "Ready4useRecord", function (x, consent_1L_chr = "", consent_indcs_int = 1L, gh_prerelease_1L_lgl = T, 
    gh_repo_desc_1L_chr = "Supplementary Files", key_1L_chr = Sys.getenv("DATAVERSE_KEY"), 
    options_chr = c("Y", "N"), publish_dv_1L_lgl = F, type_1L_chr = "prefer_dv", 
    ...) 
{
    ...
    if (!identical(repos_chr, character(0))) {
        if ("dv" %in% repos_chr) {
            ...
            ds_ls <- ready4::write_env_objs_to_dv(env_objects_ls = x@b_Ready4useIngest@objects_ls, 
                ...
                publish_dv_1L_lgl = publish_dv_1L_lgl, server_1L_chr = server_1L_chr)
        ...
        if ("gh" %in% repos_chr) {
            ...
            ready4::write_env_objs_to_dv(env_objects_ls = x@b_Ready4useIngest@objects_ls, 
                ...
                options_chr = options_chr, piggyback_desc_1L_chr = gh_repo_desc_1L_chr, 
...
methods::setMethod("share", "Ready4useRepos", function (x, obj_to_share_xx, fl_nm_1L_chr, consent_1L_chr = "", 
    consent_indcs_int = 1L, description_1L_chr = NA_character_, 
    gh_prerelease_1L_lgl = T, gh_repo_desc_1L_chr = "Supplementary Files", 
    key_1L_chr = Sys.getenv("DATAVERSE_KEY"), options_chr = c("Y", 
        "N"), publish_dv_1L_lgl = T, type_1L_chr = "prefer_dv", 
    ...) 
{
    ...
    y_Ready4useRecord <- ready4::share(y_Ready4useRecord, consent_1L_chr = consent_1L_chr, 
        consent_indcs_int = consent_indcs_int, gh_prerelease_1L_lgl = gh_prerelease_1L_lgl, 
        gh_repo_desc_1L_chr = gh_repo_desc_1L_chr, key_1L_chr = key_1L_chr, 
        options_chr = options_chr, publish_dv_1L_lgl = publish_dv_1L_lgl, 
