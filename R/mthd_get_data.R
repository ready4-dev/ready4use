#' Get data.ready4 dataverse import
#' @description get_data.ready4_dv_import_lup() is a Get Data generic that retrieves data from R objects loaded in memory.NA
