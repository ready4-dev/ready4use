...
#' Make new ready4use package dataverse import lookup table ready4 S3 class for tibble object lookup table of files to be imported from a dataverse.
...
#' Make prototype ready4use package dataverse import lookup table ready4 S3 class for tibble object lookup table of files to be imported from a dataverse.
...
#' Validate ready4use package dataverse import lookup table ready4 S3 class for tibble object lookup table of files to be imported from a dataverse.
...
"",
{
class_lup <- make_pt_ready4use_dv_import_lup() %>% 
dplyr::summarise_all(class) %>% 
 tidyr::gather(variable,class) %>% 
 dplyr::filter(!is.na(class))
...
x}
#' Is ready4use package dataverse import lookup table ready4 S3 class for tibble object lookup table of files to be imported from a dataverse.
