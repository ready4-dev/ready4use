        ...
        x$clss_to_apply_ls %>% purrr::walk2(names(x$clss_to_apply_ls), 
            ~{
                ...
                .x %>% purrr::walk(~{
                  ...
                  pkg_ds_ls_ls[[idx_1L_int]]$db_df %>% fun_fn %>% 
                    ready4fun::write_and_doc_ds(db_1L_chr = pkg_ds_ls_ls[[idx_1L_int]]$db_1L_chr, 
                      title_1L_chr = pkg_ds_ls_ls[[idx_1L_int]]$title_1L_chr, 
                      desc_1L_chr = pkg_ds_ls_ls[[idx_1L_int]]$desc_1L_chr, 
                      url_1L_chr = pkg_ds_ls_ls[[idx_1L_int]]$url_1L_chr, 
